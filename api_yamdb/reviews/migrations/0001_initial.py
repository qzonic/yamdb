# Generated by Django 3.2 on 2023-02-18 16:35
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('confirmation_code', models.CharField(default='cade1d85-a6ba-4df3-a2db-f1109365ccb1', max_length=50, verbose_name='Код подтверждения')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reviews', to=settings.AUTH_USER_MODEL, verbose_name='Имя пользователя')),
        ...
        migrations.AddConstraint(
            model_name='review',
            constraint=models.UniqueConstraint(fields=('title_id', 'author'), name='Одно произведение- один отзыв одному автору'),
        ),
        migrations.AddConstraint(
            model_name='user',
            constraint=models.UniqueConstraint(fields=('username', 'email'), name='unique username and email'),
        ),
    ]
